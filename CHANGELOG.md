...
### November 19, 2023
1. New designs for serverless pane
2. Minor fixes for Github app
3. Support for private repositories. Now Serverless functions can be deployed from private repos

### November 14, 2023
1. Added new AWS access keys
2. Split `unzipFilesForCompilation` into multiple functions
3. Added errors for unzipping
4. Fixed `dirname` errors and added correct paths for code compilation.
5. Fix serverless GraphQL queries
6. Decouples `zipFilesAndUploadToS3` into `zipFiles` and `uploadToS3`

### October 31, 2023
1. Initial POC for new Twitter app
2. Idea: Build a twitter app that auto-schedules tweets

### September 6, 2023
1. Better styling for features and prices on Hero page
...
4. Added docker tags for v0.3.0
